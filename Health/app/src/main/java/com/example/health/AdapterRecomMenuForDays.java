...
public class AdapterRecomMenuForDays extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    private ValueRecommendedMenu valueRecomMenu;

    public AdapterRecomMenuForDays(ValueRecommendedMenu valueRecomMenu) {
        this.valueRecomMenu = valueRecomMenu;
    }
    ...
    class DayMenusViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(int position) {
            ...
            for (int i = 0; i < valueRecomMenu.getProductsInFoodMenu().size(); i++) {
                if (valueRecomMenu.getProductsInFoodMenu().get(i).getDayOfWeek() == dayOfWeek) {
                    switch (valueRecomMenu.getProductsInFoodMenu().get(i).getEating()) {
                        case 1:
                            breakfast.append(countBreakfast).append(". ")
                                    .append(valueRecomMenu.getProductsInFoodMenu().get(i).getProductName())
                                    .append("   ")
                                    .append(valueRecomMenu.getProductsInFoodMenu().get(i).getWeight())
                                    .append("г.")
                                    .append("\n");
                            countBreakfast++;
                            break;
                    ...
                    calories += valueRecomMenu.getProductsInFoodMenu().get(i).getProductCalories() *
                        valueRecomMenu.getProductsInFoodMenu().get(i).getWeight() / 100;
                    protein += valueRecomMenu.getProductsInFoodMenu().get(i).getProductProtein() *
                            valueRecomMenu.getProductsInFoodMenu().get(i).getWeight() / 100;
                    fat += valueRecomMenu.getProductsInFoodMenu().get(i).getProductFat() *
                            valueRecomMenu.getProductsInFoodMenu().get(i).getWeight() / 100;
                    carbohydrate += valueRecomMenu.getProductsInFoodMenu().get(i).getProductCarbohyd() *
                            valueRecomMenu.getProductsInFoodMenu().get(i).getWeight() / 100;
                }
            }
    ...
    class ResultMenusViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind() {
            ...
            for (int i = 0; i < valueRecomMenu.getProductsInFoodMenu().size(); i++) {
                resultCalories += valueRecomMenu.getProductsInFoodMenu().get(i).getProductCalories() *
                        valueRecomMenu.getProductsInFoodMenu().get(i).getWeight() / 100;
                resultProtein += valueRecomMenu.getProductsInFoodMenu().get(i).getProductProtein() *
                        valueRecomMenu.getProductsInFoodMenu().get(i).getWeight() / 100;
                resultFat += valueRecomMenu.getProductsInFoodMenu().get(i).getProductFat() *
                        valueRecomMenu.getProductsInFoodMenu().get(i).getWeight() / 100;
                resultCarbohydrate += valueRecomMenu.getProductsInFoodMenu().get(i).getProductCarbohyd() *
                        valueRecomMenu.getProductsInFoodMenu().get(i).getWeight() / 100;
            }
